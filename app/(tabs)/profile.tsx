...
export default function Profile() {
    const transactions = [
        { id: 1, type: 'out', name: 'Withdrew to MiniPay', date: 'Apr 15, 2025', amount: '-50 pts' },
        { id: 2, type: 'in', name: 'Walking Reward', date: 'Apr 17, 2025', amount: '+12 pts' },
    ];
        ...
        <SafeAreaView className=" bg-white" style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
                <View className="min-h-screen pb-4">
                    ...
                    {/* Profile Hero — solid green instead of gradient */}
                    <View
                    ...
                    >
                        <View
                            ...
                            style={{ backgroundColor: 'rgba(255,255,255,0.2)', borderColor: 'rgba(255,255,255,0.36)' }}
                        >
                    ...
                    {/* Wallet Card — solid white instead of gradient */}
                    <View
                    ...
                    <View className="flex-row gap-2.5 px-4 pt-3.5 pb-3.5">
                        {[
                            { value: '24.1k', label: 'Steps', color: colors.g500 },
                            { value: '142', label: 'Points', color: colors.amber },
                            { value: '#1', label: 'Rank', color: colors.n800 },
                        ].map((stat) => (
                            <View
                                key={stat.label}
                                ...
                                style={{ borderColor: colors.n100 }}
                            >
                                <Text className="text-[22px] font-extrabold" style={{ color: stat.color }}>{stat.value}</Text>
